...
// Pre-validated 7-letter words for fallback and seeding
const CANDIDATE_WORDS = [
  'STRANGE', 'STRAINS', 'PLAYERS', 'STARTED', 'TURNING', 'GARDENS', 'ANSWERS',
  'WORKING', 'HOLDING', 'FARMERS', 'MATTERS', 'PAINTED', 'CREATED', 'NEAREST',
  'HUNTERS', 'LASTING', 'MASTERS', 'GRANTED', 'WESTERN', 'SHARPEN', 'STRINGS',
  'PLANETS', 'TRAINED', 'TRAVELS', 'SLANTED', 'PLANTED', 'CHANGER', 'BLASTER',
  'PRATERS', 'RANTERS', 'STANDER', 'RANTING', 'STARING', 'RATINGS', 'GRASPER',
  'STAMPER', 'GARNERS', 'STRANDS', 'READING', 'LOADING', 'BEADING', 'LEADING',
  'HEADING', 'TRADING', 'WARDING', 'WANDERS', 'CINDERS', 'FINDERS', 'BINDERS',
];
